...
public final class NavigationHeaderBinding implements ViewBinding {
  ...
  private NavigationHeaderBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imgHeader) {
  ...
  public static NavigationHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavigationHeaderBinding((RelativeLayout) rootView, imgHeader);
    }
